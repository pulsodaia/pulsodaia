# Instagram - Claude Code Corrige Instabilidade em Solicitações de Permissão de Agentes

**Categoria:** LANCAMENTO
**Link no perfil:** pulsodaia.com.br
**Hero original:** https://pulsodaia.com.br/feed/claude-code-corrige-instabilidade-em-solicitacoes-de-permissao-de-agentes/hero.jpg
...
---CARD 1 (CAPA)---
Claude Code: Fim dos travamentos.

Atualização corrige falha em permissões de agentes de IA.
🧡

---CARD 2 (INSIGHT)---
A Anthropic lançou a v2.1.114 do Claude Code. A atualização resolve um problema que causava travamentos quando um agente de IA solicitava permissão para usar ferramentas de outro. Isso é crucial para a colaboração e autonomia de sistemas de IA.
...
Agentes de IA paravam de funcionar.
